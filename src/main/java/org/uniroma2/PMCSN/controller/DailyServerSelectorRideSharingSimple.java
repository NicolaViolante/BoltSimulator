...
public class DailyServerSelectorRideSharingSimple {
    ...
    private final NavigableMap<Integer, DailyServerSelectorRideSharingSimple.Category> schedule = new TreeMap<>();

    public DailyServerSelectorRideSharingSimple(ConfigurationManager config) {
        // leggo dal file di configurazione
        this.smallVeryLow = config.getInt("simple", "smallverylow");
        this.mediumVeryLow = config.getInt("simple", "mediumverylow");
        this.largeVeryLow = config.getInt("simple", "largeverylow");

        this.smallLow = config.getInt("simple", "smalllow");
        this.mediumLow = config.getInt("simple", "mediumlow");
        this.largeLow = config.getInt("simple", "largelow");

        this.smallMed = config.getInt("simple", "smallmedium");
        this.mediumMed = config.getInt("simple", "mediummedium");
        this.largeMed = config.getInt("simple", "largemedium");

        this.smallHigh = config.getInt("simple", "smallhigh");
        this.mediumHigh = config.getInt("simple", "mediumhigh");
        this.largeHigh = config.getInt("simple", "largehigh");

        this.smallVeryHigh = config.getInt("simple", "smallveryhigh");
        this.mediumVeryHigh = config.getInt("simple", "mediumveryhigh");
        this.largeVeryHigh = config.getInt("simple", "largeveryhigh");
